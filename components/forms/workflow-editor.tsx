...
import { WorkflowStepList } from "@/components/workflow-editor/workflow-step-list";
...
const WorkflowCanvas = dynamic(
  () => import("@/components/workflow-editor/workflow-canvas").then((module) => module.WorkflowCanvas),
  { loading: () => <div aria-label="Loading workflow canvas" className="h-[28rem] animate-pulse rounded-2xl bg-slate-100 dark:bg-slate-900" role="status" />, ssr: false },
);
