...
export function SchedulesPage() {
  ...
  return (
    <div className="space-y-8">
      <header><p className="text-sm font-semibold uppercase tracking-[0.16em] text-violet-600">Schedules</p><h1 className="mt-2 text-4xl font-semibold tracking-[-0.04em]">Put durable work on a clock.</h1><p className="mt-3 max-w-2xl text-slate-500">Use bounded CRON, interval, and one-time schedules with explicit misfire behavior. A schedule starts an existing workflow at a time you choose.</p></header>
