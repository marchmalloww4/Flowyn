...
export function AIPage() {
  ...
  return (
    <div className="space-y-8">
      <header><p className="text-sm font-semibold uppercase tracking-[0.16em] text-violet-600">AI</p><h1 className="mt-2 text-4xl font-semibold tracking-[-0.04em]">Generate with guardrails.</h1><p className="mt-3 max-w-2xl text-slate-500">Use the existing provider-neutral generation route with an explicit workspace and optional validated brand context. AI drafts stay inside Flowyn until you choose an approved workflow.</p></header>
